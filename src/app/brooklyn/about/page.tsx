  ...
  return (
    <>
      ...
      <main>
        ...
        {/* Values */}
        {brooklyn.values && <ValuePillars pillars={brooklyn.values} />}

        {/* Team */}
        {brooklyn.team && (
          <SectionWrapper className="py-20 flex flex-col gap-16">
            <TeamGrid members={brooklyn.team} />
            {brooklyn.alumniTeam && (
              <TeamGrid members={brooklyn.alumniTeam} heading="Alumni volunteers" />
            )}
          </SectionWrapper>
        )}
        ...
        <SectionWrapper as="div" className="py-16 border-t border-just-grey/20">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            ...
            <div className="flex flex-wrap gap-4">
              <Button variant="primary" href="https://lu.ma/bkproductdesign" target="_blank">
                See events
              </Button>
              <Button variant="secondary" href="https://forms.gle/mobrphDchV83EdQK9" target="_blank">
                Volunteer
              </Button>
            </div>
          </div>
