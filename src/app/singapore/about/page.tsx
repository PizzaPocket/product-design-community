  ...
  return (
    <>
      ...
      <main>
        ...
        {/* Values */}
        {singapore.values && <ValuePillars pillars={singapore.values} />}

        {/* Team */}
        {singapore.team && (
          <SectionWrapper className="py-20 flex flex-col gap-16">
            <TeamGrid members={singapore.team} />

            {singapore.alumniTeam && (
              <TeamGrid members={singapore.alumniTeam} heading="Alumni volunteers" />
            )}
          </SectionWrapper>
        )}
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div className="flex flex-col gap-2">
              ...
              <p
                ...
                style={{ fontSize: "var(--text-b2)", lineHeight: "var(--lh-b2)" }}
              >
                Come to an event or sign up to volunteer with the team.
              </p>
            </div>
            <div className="flex flex-wrap gap-4">
              <Button variant="primary" href="https://lu.ma/singaporeproductdesign" target="_blank">
                See events
              </Button>
              <Button variant="secondary" href="https://forms.gle/volunteer-spd" target="_blank">
                Volunteer
              </Button>
            </div>
          </div>
